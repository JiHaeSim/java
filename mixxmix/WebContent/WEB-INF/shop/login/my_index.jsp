...
<body>
	...
	<table width="70%">
		...
		<tr align="center">
			<td>
				...
				<a href="<%=request.getContextPath()%>/myshop/shop/mypage/order/order_list.jsp">주문내역</a> | 
				<a href="<%=request.getContextPath()%>">회원정보</a> | 
				<a href="<%=request.getContextPath()%>/myshop/shop/mypage/my_wish_list.jsp">관심상품</a> | 
				<a href="<%=request.getContextPath()%>/myshop/shop/mypage/my_pointList.jsp">적립금</a> | 
				<a href="<%=request.getContextPath()%>/myshop/shop/mypage/my_coupon.jsp">쿠폰</a> | 
				<a href="<%=request.getContextPath()%>">게시물관리</a> | 
				<a href="<%=request.getContextPath()%>/myshop/shop/mypage/addr/list.jsp">배송주소록</a> | 
			</td>
		</tr>
	</table>
	<br>
	...
	<table border=1 cellpadding="30" bordercolor="#D8D8D8" width="100%" height="100">
		<tr>
			...
			<td align="right">
				${point}원<img src="../../../../img/find.jpg" class="location1"><br><br>
				${point}원<img src="../../../../img/find.jpg" class="location1"><br><br>
				${count}회
			</td>
			<td>
			...
			<td align="right">
				${money}원<br><br>
				${money}원<br><br>
				${coupon}개<img src="../../../../img/find.jpg" class="location1">
			</td>
		</tr>
	</table>
	<br>
